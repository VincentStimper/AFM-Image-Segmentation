...
train_step_start = [200, 400, 600, 800]
...
with tf.Session() as sess:
    ...
    # Build network
    vgg_fcn = fcn4_vgg.FCN4VGG(vgg16_npy_path='vgg16.npy', load_semantic_net=False)
    ...
    var_list5 = var_list_fc + var_list_upscore + var_list_fr + var_list_p4 + var_list_p3 + var_list_p2 + var_list_conv
